...
String url = "jdbc:oracle:thin:@workstation:1521:XE";
    ...
    private void initComponents() {
        ...
        jLabel3.setBounds(450, 190, 170, 40);
        ...
        jButton1.setBounds(300, 400, 70, 30);
        ...
        jButton2.setBounds(150, 400, 90, 30);
        ...
        jButton3.setBounds(440, 280, 110, 30);

        jLabel5.setFont(new java.awt.Font("Nirmala UI", 0, 12)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(0, 204, 204));
        jLabel5.setText("jLabel5");
        getContentPane().add(jLabel5);
        jLabel5.setBounds(50, 40, 50, 16);

        jButton4.setBackground(new java.awt.Color(0, 153, 0));
        jButton4.setFont(new java.awt.Font("Nirmala UI", 0, 22)); // NOI18N
        ...
        jLabel7.setBounds(20, 250, 120, 60);
        ...
        jLabel9.setBounds(30, 330, 90, 60);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try{
            ...
            ResultSet rs=stmt.executeQuery("select S_ID from stadium");
            while(rs.next()){
                Object row[]=new Object[1];
                row[0]=rs.getObject(1).toString();
                if(row[0].equals(Sid)){
                    sql="delete from stadium where S_id='"+Sid+"'";
                    stmt.execute(sql);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
            ...
            while(rs.next()){
                ...
                row[0]=rs.getObject(1).toString();
                if(row[0].equals(Sid)){                   
                    stmt.execute("update stadium set SNAME='"+Sname+"',SCAPACITY="+Scapacity+",SCOUNTRY='"+Scountry+"'  where S_ID="+Sid);
